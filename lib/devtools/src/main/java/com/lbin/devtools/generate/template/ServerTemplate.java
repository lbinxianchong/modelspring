...
import com.lbin.devtools.generate.utils.jAngel.nodes.FieldNode;
import com.lbin.devtools.generate.utils.jAngel.nodes.Node;
...
public class ServerTemplate {
    ...
    private static Document genClazzBody(Generate generate) {
        ...
        String path = FileUtil.templatePath(ServerTemplate.class);

        // 获取jAngel文档对象
        Document document = JavaParseUtil.document(path, expression, generate, TierType.SERVER);
    ...
    public static String generate(Generate generate) {
        // 生成文件
        String filePath = GenerateUtil.getJavaFilePath(generate, TierType.SERVER);
        try {
