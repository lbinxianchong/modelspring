...
public class XmlParseUtil {
    ...
    /** modules模块pom文件路径 */
    private static final String POM_PATH = String.format("%s/%s/pom.xml", ConfigUtil.getProjectPath(), MODULE_NAME);
    ...
    public static String getDependency(String moduleName){
        ...
        dependency.append(CodeUtil.blank(12)).append("<groupId>com.lbin.modules</groupId>").append(LINE_BREAK);
