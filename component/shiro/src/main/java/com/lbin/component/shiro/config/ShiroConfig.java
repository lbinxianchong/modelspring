...
public class ShiroConfig {
    ...
    @Bean
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager, NetworkProjectProperties properties) {
        ...
        String[] defaultExcludes = properties.getDefaultExcludes().split(",");
     ...
     */
    @Bean
    public DefaultWebSessionManager getDefaultWebSessionManager(EhCacheManager cacheManager, NetworkProjectProperties properties) {
     ...
     */
    @Bean
    public SimpleCookie rememberMeCookie(NetworkProjectProperties properties) {
