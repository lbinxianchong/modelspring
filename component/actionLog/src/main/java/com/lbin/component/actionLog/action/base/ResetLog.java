...
import com.lbin.component.actionLog.annotation.EntityParam;
...
public class ResetLog {
    ...
    public boolean isSuccess() {
        boolean resultVo = retValue instanceof ResultVo;
        boolean success = ((ResultVo) retValue).getCode().equals(ResultEnum.SUCCESS.getCode());
    ...
    public String fillRule(Object beanObject, String content) {
        ...
        while (matcher.find()) {
            ...
            String fill = null;
            fill = String.valueOf(ReflectUtil.getFieldValue(beanObject, property));
